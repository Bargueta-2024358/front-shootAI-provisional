        ...
        return (
          <div key={key}>
            ...
            {activeItem && (
              ...
              >
                <p className="font-body text-[10px] text-charcoal mr-1">Color:</p>
                {activeItem.colors.map((c) => (
                  <button
                    ...
                    className={`h-7 w-7 rounded-sm ring-1 transition-all duration-200 ${
                      color === c.hex ? 'ring-caramel ring-2 scale-110' : 'ring-silver/40 hover:scale-105'
                    }`}
            ...
            {!avatar ? (
              ...
              >
                ...
                <div className="w-full lg:w-[45%] lg:sticky lg:top-28">
                  <div className="border-t border-silver pt-6 mb-6">
                    <p className="font-display text-xs tracking-[0.35em] uppercase text-mid-gray">
